...
<div class="container light-style flex-grow-1 container-p-y">
      ...
      <div class="row no-gutters row-bordered row-border-light">
        <div class="col-md-3 pt-0">
          <div class="list-group list-group-flush account-settings-links">
            <a class="list-group-item list-group-item-action active" data-toggle="list" href="#account-select">Medcard creation</a>
          </div>
        </div>
    ...
    <div class="text-right mt-3">
      <button type="button" class="btn btn-primary" onclick = "sendForm();">Create record</button>&nbsp;
    </div>
</div>
...
<script type="text/javascript"></script>
    ...
    sendData.diseaseName = $("#disease").val();
    sendData.diagnoseDate = $("#diagnoseDate").val();
    sendData.dischargeDate = $("#dischargeDate").val();
    sendData.notes = $("#notes").val();
        $.ajax({
          url: "${pageContext.request.contextPath}/doctorDashboard/medcards/create",
          type: "post",
          dataType: "json",
          ...
          statusCode: {
            201: function() {
                $('#response').text("Record created!");
                },
            400: function() {
                $('#responseError').text("Error while creating. Check your inputs!");
                }
            }
        })
    }
