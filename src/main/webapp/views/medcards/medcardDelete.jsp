...
<div class="container">
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      ...
      <a class="p-2 link-secondary" href="updatePage">Medcard update</a>
      <a class="p-2 link-secondary" href="createPage">Medcard creation</a>
      <a class="p-2 link-secondary" href="deletePage">Medcard deletion</a>
    </nav>
  </div>
</div>
...
<div class="container light-style flex-grow-1 container-p-y">
      ...
      <div class="row no-gutters row-bordered row-border-light">
        <div class="col-md-3 pt-0">
          <div class="list-group list-group-flush account-settings-links">
            <a class="list-group-item list-group-item-action active" data-toggle="list" href="#account-select">Medcard deletion</a>
          </div>
        </div>
    ...
    <div class="text-right mt-3">
      <button type="button" class="btn btn-primary" onclick = "sendForm();">Delete record</button>&nbsp;
    </div>
</div>
...
<script type="text/javascript"></script>
    ...
    sendData.diagnoseDate = $("#diagnoseDate").val();
        $.ajax({
          url: "${pageContext.request.contextPath}/doctorDashboard/medcards/delete",
          type: "delete",
          dataType: "json",
