...
<div class="container light-style flex-grow-1 container-p-y">
      ...
      <div class="row no-gutters row-bordered row-border-light">
        <div class="col-md-3 pt-0">
          <div class="list-group list-group-flush account-settings-links">
            <a class="list-group-item list-group-item-action active" data-toggle="list" href="#account-select">Profile creation</a>
          </div>
        </div>
    ...
    <div class="text-right mt-3">
      <button type="button" class="btn btn-primary" onclick = "sendForm();">Create profile</button>&nbsp;
    </div>
</div>
...
<script type="text/javascript"></script>
    ...
    sendData.password = $("#password").val();
        $.ajax({
          url: "${pageContext.request.contextPath}/dashboard/profiles/create",
          type: "post",
          dataType: "json",
          data: JSON.stringify(sendData),
          contentType: 'application/json',
          statusCode: {
            201: function(receivedData) {
