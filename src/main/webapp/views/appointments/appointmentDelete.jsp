...
<div class="container light-style flex-grow-1 container-p-y">
      ...
      <div class="row no-gutters row-bordered row-border-light">
        <div class="col-md-3 pt-0">
          <div class="list-group list-group-flush account-settings-links">
            <a class="list-group-item list-group-item-action active" data-toggle="list" href="#account-select">Appointment deletion</a>
          </div>
        </div>
    ...
    <div class="text-right mt-3">
      <button type="button" class="btn btn-primary" onclick = "sendForm();">Delete appointment</button>&nbsp;
    </div>
</div>
...
<script type="text/javascript"></script>
    ...
    sendData.dateTime = $("#date").val();
        $.ajax({
          url: "${pageContext.request.contextPath}/doctorDashboard/appointments/delete",
          type: "delete",
          dataType: "json",
          ...
          statusCode: {
            200: function(receivedData) {
                $('#response').text("Appointment deleted!");
                },
            400: function() {
                $('#responseError').text("Appointment doesn't exist!");
                }
            }
        })
    }
